            ...
            children: [
              ...
              Padding(
                ...
                child: SizedBox(
                    height: 40,
                    width: 40,
                    child: widget.entry.mood.toImage()),
              )
            ],
          ),
          Padding(
            padding: const EdgeInsets.fromLTRB(12, 5, 0, 0),
            child: Text(widget.entry.title, style: TextStyle(color: Theme.of(context).colorScheme.secondary, fontSize: 25)),
          ),
          Padding(
            padding: const EdgeInsets.fromLTRB(12, 5, 12, 0),
            child: Text(widget.entry.text, style: TextStyle(color: Theme.of(context).colorScheme.primary.withOpacity(0.7), fontSize: 15)),
          ),
        ],
      ),
    );
